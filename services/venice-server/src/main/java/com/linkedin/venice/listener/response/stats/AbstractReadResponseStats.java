...
import static com.linkedin.venice.stats.StatsUtils.consumeDoubleAndBooleanIfAbove;
import static com.linkedin.venice.stats.StatsUtils.consumeDoubleIfAbove;
import static com.linkedin.venice.stats.StatsUtils.consumeIntIfAbove;
...
public abstract class AbstractReadResponseStats implements ReadResponseStats, ReadResponseStatsRecorder {
  ...
  public void recordMetrics(ServerHttpRequestStats stats) {
    ...
    // Other metrics are ignored in this class, but can be recorded by subclasses
  }
  ...
  public double getAndClearStorageExecutionSubmissionWaitTime() {
    double storageExecutionSubmissionWaitTimeValue = this.storageExecutionSubmissionWaitTime;
    this.storageExecutionSubmissionWaitTime = UNINITIALIZED;
    return storageExecutionSubmissionWaitTimeValue;
  }
