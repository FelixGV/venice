        ...
        case FAIL:
          timeoutTask = new TimeoutTask() {
            ...
            public void onTimeout(AcquireTask task) {
              ...
              task.promise
                  .setFailure(new TimeoutException("Acquire operation took longer then configured maximum time") {
                    @Override
  ...
  private class AcquireListener implements FutureListener<Channel> {
    ...
    public void operationComplete(Future<Channel> future) throws Exception {
      ...
      if (closed) {
        ...
        originalPromise.setFailure(new IllegalStateException("EspressoFixedChannelPool was closed"));
        return;
      }
