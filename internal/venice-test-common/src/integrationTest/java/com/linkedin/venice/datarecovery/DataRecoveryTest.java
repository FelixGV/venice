...
public abstract class DataRecoveryTest {
  ...
  public void setUp() {
    ...
    serverProperties.setProperty(SERVER_SHARED_CONSUMER_ASSIGNMENT_STRATEGY, getConsumerAssignmentStrategy().name());
  ...
  @Test(timeOut = TEST_TIMEOUT * 2, invocationCount = 10)
