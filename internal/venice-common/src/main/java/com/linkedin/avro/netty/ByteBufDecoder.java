...
/**
 * Copied from the archived project: https://github.com/milenkovicm/avro-netty
 *
...
public class ByteBufDecoder extends Decoder {
  ...
  public double readDouble() throws IOException {
    final long n =
        (((long) this.buffer.readUnsignedByte()) & 0xff) | ((((long) this.buffer.readUnsignedByte()) & 0xff) << 8)
            | ((((long) this.buffer.readUnsignedByte()) & 0xff) << 16)
            | ((((long) this.buffer.readUnsignedByte()) & 0xff) << 24)
            | ((((long) this.buffer.readUnsignedByte()) & 0xff) << 32)
            | ((((long) this.buffer.readUnsignedByte()) & 0xff) << 40)
            | ((((long) this.buffer.readUnsignedByte()) & 0xff) << 48)
            | ((((long) this.buffer.readUnsignedByte()) & 0xff) << 56);
